...
class Wall:
    ...
    def collision(self,arrows,units):
        for j in range(len(arrows)):
            if  arrows[j].x < self.x+self.w and arrows[j].y < self.y+self.h and arrows[j].y > self.y and arrows[j].orientation == 'left':
                arrows[j].x = self.x+self.w
                arrows[j].speed =0
            if  arrows[j].x > self.x and arrows[j].y < self.y+self.h and arrows[j].y > self.y and arrows[j].orientation == 'right':
                arrows[j].x = self.x
                arrows[j].speed =0
            if  arrows[j].y < self.y+self.w  and arrows[j].x < self.x+self.w and arrows[j].x > self.x and arrows[j].orientation == 'top':
                arrows[j].y = self.y +self.w
                arrows[j].speed =0
            if  arrows[j].y > self.y and arrows[j].x < self.x+self.w and arrows[j].x > self.x and arrows[j].orientation == 'bot':
                arrows[j].y = self.y
                arrows[j].speed = 0
        for k in range(len(units)):
            if units[k].x +units[k].width> self.x and units[k].x < self.x +self.w and units[k].y < self.y+self.h and units[k].y+units[k].height > self.y and units[k].orientation == 'right':
                units[k].x = self.x -units[k].width
            if units[k].x +units[k].width> self.x and units[k].x < self.x +self.w and units[k].y < self.y+self.h and units[k].y +units[k].height> self.y and units[k].orientation == 'left':
                units[k].x = self.x + self.w
            if units[k].x +units[k].width> self.x and units[k].x < self.x +self.w and units[k].y < self.y+self.h and units[k].y+ units[k].height > self.y and units[k].orientation == 'bot':
                units[k].y = self.y-units[k].height
            if units[k].x +units[k].width> self.x and units[k].x < self.x +self.w and units[k].y < self.y+self.h and units[k].y+ units[k].height > self.y and units[k].orientation == 'top':
...
class Unit:
    ...
    def stay(self,walls):
        ...
        for i in range(len(walls)):
            if not (self.x +self.width> walls[i].x and self.x < walls[i].x +walls[i].w and self.y < walls[i].y+walls[i].h and self.y+self.height > walls[i].y):
                if self.Vx > 0:
